...
array.map.with_index { |buy_price, buy_day|
  array.map.with_index{ |sell_price, sell_day|
  if sell_day > buy_day
...
results = profit.sort_by{|days,profit| #=>using the sort_by method w/ key/value pairs of profit.
profit#=> using values 
}
