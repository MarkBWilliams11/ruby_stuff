...
puts 'yes 1 is less than 2 and five is less than 6' if 1 < 2 && 5 < 6
# we can just type and it will still work
puts ' This also works' if (1 < 2) && (5 < 6)
# NOTE: when using && || ,expressions are evaluated from left to right
...
puts 'we are learning' if 10 < 2 || 5 < 6 #=> first is false, but second is true
# we can also type or
puts 'This also works' if (20 > 5) || (5 < 1)
